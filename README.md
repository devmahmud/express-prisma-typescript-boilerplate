# Typescript RESTful API Node Server Boilerplate
...
```bash
git clone https://github.com/devmahmud/express-prisma-typescript-boilerplate.git
...
- [Typescript RESTful API Node Server Boilerplate](#typescript-restful-api-node-server-boilerplate)
